...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Selector.max_amount_of_childs'
        db.add_column('aggregator_selector', 'max_amount_of_childs', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Selector.max_amount_of_childs'
        db.delete_column('aggregator_selector', 'max_amount_of_childs')
    ...
    models = {
        ...
        'aggregator.selector': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_amount_of_childs': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
