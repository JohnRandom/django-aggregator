...
from dasdocc.aggregator.lib.updaters.static_content_updater import (
    _StaticContentUpdater)
...
class PublicInterfaceTests(TestCase):
    ...
    @patch('dasdocc.aggregator.lib.updaters.static_content_updater.'
        'StaticContentParser')
    ...
    @raises(TypeError)
    def test_should_raise_type_error_on_non_instance_method_run(self):
