...
from dasdocc.aggregator.models import Feed, Entry, ParsingError
from dasdocc.aggregator.lib.updaters import feed_updater
...
@patch('dasdocc.aggregator.lib.updaters.feed_updater.datetime', new = mocked_datetime)
