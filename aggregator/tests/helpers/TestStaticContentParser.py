...
from aggregator.tests.factories import StaticContentMock, static_content_parsed, SelectorMock
...
class InterfaceTests(TestCase):
	...
	@patch('aggregator.lib.static_content_helpers.html.parse')
...
class ContentProcessingTests(TestCase):
	...
	@patch('aggregator.lib.static_content_helpers.datetime', new = mocked_datetime)
	def test_processing_is_assigned_to_staticcontent_object(self):
