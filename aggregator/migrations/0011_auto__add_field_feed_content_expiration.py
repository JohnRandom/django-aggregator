...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.content_expiration'
        db.add_column('aggregator_feed', 'content_expiration', self.gf('django.db.models.fields.SmallIntegerField')(default=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.content_expiration'
        db.delete_column('aggregator_feed', 'content_expiration')
