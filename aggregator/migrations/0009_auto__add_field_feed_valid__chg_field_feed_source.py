...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.valid'
        db.add_column('aggregator_feed', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Feed.source'
        db.alter_column('aggregator_feed', 'source', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'Feed.valid'
        db.delete_column('aggregator_feed', 'valid')

        # Changing field 'Feed.source'
        db.alter_column('aggregator_feed', 'source', self.gf('django.db.models.fields.URLField')(max_length=255))
