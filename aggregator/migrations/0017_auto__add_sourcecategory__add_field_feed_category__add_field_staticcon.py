...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('aggregator_feed', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aggregator.SourceCategory'], null=True, blank=True), keep_default=False)

        # Adding field 'StaticContent.category'
        db.add_column('aggregator_staticcontent', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aggregator.SourceCategory'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('aggregator_feed', 'category_id')

        # Deleting field 'StaticContent.category'
        db.delete_column('aggregator_staticcontent', 'category_id')
