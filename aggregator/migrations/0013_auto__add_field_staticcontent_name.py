...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticContent.name'
        db.add_column('aggregator_staticcontent', 'name', self.gf('django.db.models.fields.CharField')(default='vergangene projecte', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticContent.name'
        db.delete_column('aggregator_staticcontent', 'name')
