...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.trashed_at'
        db.add_column('aggregator_feed', 'trashed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.trashed_at'
        db.delete_column('aggregator_feed', 'trashed_at')
