...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('aggregator_feed', 'language', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Feed.language_code'
        db.add_column('aggregator_feed', 'language_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.language'
        db.delete_column('aggregator_feed', 'language')

        # Deleting field 'Feed.language_code'
        db.delete_column('aggregator_feed', 'language_code')
